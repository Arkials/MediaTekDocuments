...
namespace MediaTekDocumentsTestsParutionDansAbonnement.view.Tests
{
    [TestClass()]
    public class FrmMediatekTests
    {
        ...
        public void ParutionDansAbonnementTest()
        {
            ...
            Assert.AreEqual(frmMediatek.ParutionDansAbonnement(dateCommande, dateFinAbonnement, dateAchatPendant), false);
        }
    }
}